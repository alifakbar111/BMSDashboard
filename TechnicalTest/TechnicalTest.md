...
*Refer to `data/DATA_DICTIONARY.md` for complete field definitions.*
...
*Note on AI Tool Usage: Using AI assistants (ChatGPT, Copilot, Claude, etc.) is permitted and encouraged. The `PROMPT_HISTORY.md` file is a scored deliverable — it demonstrates your ability to effectively leverage AI tools in your workflow.*
